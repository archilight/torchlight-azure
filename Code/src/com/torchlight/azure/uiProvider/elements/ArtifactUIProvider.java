...
public class ArtifactUIProvider extends com.archimatetool.editor.ui.factory.elements.ArtifactUIProvider {
    ...
    public EditPart createEditPart() {
        ...
        return new ArchimateElementEditPart(com.torchlight.azure.uiProvider.elements.figures.ArtifactFigure.class);
    }
    ...
    public Color getDefaultColor() {
    	...
    	if ( TorchlightAzurePlugin.bDrawAzureColour) {
       		...
       		return ColorFactory.get(165,188,213); //ColorFactory.get(230,243,255);      		
       	}
    	else {
