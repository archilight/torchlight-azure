...
public class PathUIProvider extends com.archimatetool.editor.ui.factory.elements.PathUIProvider {
    ...
    public EditPart createEditPart() {
        ...
        return new ArchimateElementEditPart(com.torchlight.azure.uiProvider.elements.figures.PathFigure.class);
    }
    ...
    public Color getDefaultColor() {
    	...
    	if ( TorchlightAzurePlugin.bDrawAzureColour) {
       		...
       		return ColorFactory.get(242, 242,242); //ColorFactory.get(102, 179,255);      		
       	}
    	else {
